                  ...
                  <Box mt="1rem">
                    {swapIsUnsupported ? (
                          ...
                          <Button
                            ...
                            style={{
                              background: (
                                ...
                                approval0x !== ApprovalState.APPROVED ||
                                is0xSwapping ||
                                (!isExpertMode && is0xPriceImpactTooHigh)) ? "#26292e" : "#506D2C"
                            }} // #3c3742
                          >
                            {
                              is0xInsufficient ?
                        ...
                        <Button
                          ...
                          style={{
                            background: (
                              ...
                              is0xSwapping ||
                              (!isExpertMode && is0xPriceImpactTooHigh) ||
                              !!swap0xCallbackError) ? "#26292e" : "#506D2C"
                          }} // #3c3742
                        >
                          {
                            is0xInsufficient ?
                      ...
                      <Button
                        ...
                        style={{ background: (!isValid || (priceImpactSeverity > 3 && !isExpertMode) || !!swapCallbackError) ? "#26292e" : "#506D2C" }} // #3c3742
                      >
                        {swapInputError ||
                          (priceImpactSeverity > 3 && !isExpertMode
